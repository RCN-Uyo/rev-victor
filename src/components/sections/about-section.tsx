...
export function AboutSection() {
  return (
    <Section id="about" className="overflow-hidden py-24 md:py-32">
      <Container>
        <Grid cols={{ sm: 1, lg: 12 }} gap="xl" className="items-center">
          
          {/* =========================================
              LEFT COLUMN: Editorial Image
              ========================================= */}
          <GridItem span={{ sm: 1, lg: 5 }} className="relative">
            <Reveal variants={slideInLeft}>
              <div className="relative aspect-[4/5] w-full rounded-2xl overflow-hidden border border-border/50 group">
                ...
                {/* Image */}
                <Image
                  src="https://picsum.photos/1080/1350?random=4" // Placeholder
          ...
          {/* =========================================
              ...
              ========================================= */}
          <GridItem span={{ sm: 1, lg: 7 }} className="lg:pl-8">
